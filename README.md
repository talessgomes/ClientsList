...
## Dark/Light Mode: Suporte a tema claro e escuro, controlado por um botão ou pela preferência do sistema.


## Estado de Loading: Simula o carregamento de dados com uma animação "spinner".


## Feedback de Busca Vazia: Exibe uma mensagem amigável caso a busca não retorne resultados.
